...
export function MailorLogo({ className }: { className?: string }) {
  return (
    <span
      className={`inline-flex items-baseline gap-2 whitespace-nowrap font-black tracking-[-0.02em] text-current ${className ?? ""}`}
    >
      <img
        src="/images/mailor-logo.png"
        alt=""
        className="h-[1em] w-auto shrink-0 self-center object-contain"
        aria-hidden
      />
      <span>Mailor</span>
    </span>
...
export function FlaskIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 3h6M10 3v6l-5 8.5c-.5.833.167 1.5 1 1.5h12c.833 0 1.5-.667 1-1.5L14 9V3" />
    </svg>
  );
}
